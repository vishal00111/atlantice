  ...
  return (
    ...
    >
      <nav className="navbar">
        <div className="logo"><img src={logoImg} alt="Banquet Logo" className="logo-img" /></div>
        <ul className="nav-links">
          <li><a href="#home">Home</a></li>
          <li><a href="#gallery">Gallery</a></li>
          <li><a href="#packages">Packagess</a></li>
          <li><a href="#contact">Contact</a></li>
          <li><a href="#menu"><i className="menu-icon">☰</i></a></li>
        </ul>
      </nav>
