    ...
    <div className="wedding-container">
      <div className="wedding-experience">
        ...
        <div className="text-section">
          ...
          <p>
            Experience a seamless, one-stop wedding service at Heritage Village Resorts & Spa, Manesar—one of the premier wedding resorts near Delhi. Our hand-picked network of leading photographers, wedding planners, salon experts, decorators, and more work together to bring your vision to life.
          </p>
          <p>
